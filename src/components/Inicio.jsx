        ...
        <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                    Un taller intensivo de 4 días para dominar las bases de la programación utilizando GitHub Copilot como tu tutor personal.
                </p>
                <button
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
                <div className="bg-white p-8 rounded-xl shadow-md border-t-4 border-indigo-500">
                    ...
                    <p className="text-gray-600 mb-4">
                        Desarrollarás las bases de la lógica de programación utilizando herramientas de IA como soporte. No solo aprenderás a escribir código, sino a colaborar con una IA para ser más eficiente.
                    </p>
            ...
            <div className="grid md:grid-cols-4 gap-4">
                {[
                    ...
                    { dia: 'Día 2', titulo: 'Lógica & Control', desc: 'Condicionales, bucles y pensamiento lógico.' },
                    { dia: 'Día 3', titulo: 'Funciones', desc: 'Modularización y buenas prácticas.' },
